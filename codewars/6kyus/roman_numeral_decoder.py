...
see: https://www.codewars.com/kata/51b6249c4612257ac0000005/train/python
...
of the Roman numeral. Modern Roman numerals are written by expressing each
decimal digit of the number to be encoded separately, starting with the leftmost
