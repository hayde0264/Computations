...
see: https://www.codewars.com/kata/52c31f8e6605bcc646000082/train/python
...
(index1, index2). For the purposes of this kata, some tests may have multiple
answers; any valid solutions will be accepted. The input will always be valid
